...
//		        input_md.addInfo("IM_VKORG", JCO.TYPE_CHAR, 255, 255 * (is_backend_unicode? 2 : 1 ), -1, 0, null, null, 0, null, null);
	     ...
	     //   input_md.addInfo("IV_E_MAIL", JCO.TYPE_CHAR, 255, 255 * 2, -1, 0, null, null, 0, null, null);
		   ...
		   //     output_md.addInfo("ES_MAILING", JCO.TYPE_STRUCTURE, 144, 0, 0, JCO.EXPORT_PARAMETER, null);
		        output_md.addInfo("ES_MAILING", JCO.TYPE_CHAR, 255, 255 * (is_backend_unicode? 2 : 1 ), -1, 0, null, null, 0, null, null);
