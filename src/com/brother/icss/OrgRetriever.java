...
public class OrgRetriever {

	public static void main(String[] args) {
		//Y_E_ICSS_ORG_FROM_EMAIL_PWRD
...
//		        input_md.addInfo("IM_VKORG", JCO.TYPE_CHAR, 255, 255 * (is_backend_unicode? 2 : 1 ), -1, 0, null, null, 0, null, null);
	        ...
	        input_md.addInfo("EMAIL", JCO.TYPE_CHAR, 255, 255 * 2, -1, 0, null, null, 0, null, null);
	        input_md.addInfo("LOGIN_LANGUAGE", JCO.TYPE_CHAR, 255, 255 * 2, -1, 0, null, null, 0, null, null);
	        // Create the input parameter list from the metadata object
		        ...
		        output_md.addInfo("COMPANY_PARTNER", JCO.TYPE_CHAR, 255, 255 * 2, -1, 0, null, null, 0, null, null);

		        // Create the output parameter list from the metadata object
		        JCO.ParameterList output = JCO.createParameterList(output_md);

		        String functionName = "Y_E_ICSS_ORG_FROM_EMAIL_PWRD";
		        // Call the function
